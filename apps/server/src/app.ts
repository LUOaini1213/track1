...
export async function createApp(
  ...
  // Fastify's default {statusCode, error, message} envelope — which the web
  // client, reading `body.error`, rendered as "Conflict" — and a Zod validation
  // failure answered 500 instead of 400.
